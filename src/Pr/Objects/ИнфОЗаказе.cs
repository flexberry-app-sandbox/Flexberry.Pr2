...
namespace IIS.Pr
{
    ...
    public class ИнфОЗаказе : ICSSoft.STORMNET.DataObject
    {
        ...
        [PropertyStorage(new string[] {
                "Товары"})]
        [NotNull()]
        public virtual IIS.Pr.Товары Товары
        {
            get
            {
                ...
                IIS.Pr.Товары result = this.fТовары;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Pr.ДокумПоставки.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ИнфОЗаказеE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ИнфОЗаказеE", typeof(IIS.Pr.ИнфОЗаказе));
                }
            }
        }
    }
    ...
    public class DetailArrayOfИнфОЗаказе : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Pr.DetailArrayOfИнфОЗаказе members)

        // *** End programmer edit section *** (IIS.Pr.DetailArrayOfИнфОЗаказе members)
        ...
        /// </summary>
        public DetailArrayOfИнфОЗаказе(IIS.Pr.ДокумПоставки fДокумПоставки) : 
                base(typeof(ИнфОЗаказе), ((ICSSoft.STORMNET.DataObject)(fДокумПоставки)))
        {
        }
        
        public IIS.Pr.ИнфОЗаказе this[int index]
        {
            get
            {
                return ((IIS.Pr.ИнфОЗаказе)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Pr.ИнфОЗаказе dataobject)
        {
