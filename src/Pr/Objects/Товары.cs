...
namespace IIS.Pr
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Pr.ЕдИзм fЕдиницыИзмер;
        ...
        public virtual IIS.Pr.ЕдИзм ЕдиницыИзмер
        {
            get
            {
                ...
                IIS.Pr.ЕдИзм result = this.fЕдиницыИзмер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.Pr.Товары));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыL", typeof(IIS.Pr.Товары));
                }
            }
        }
    }
